...
$Samsung = ['Satu' => "Samsung Galaxy S22", 'Dua' =>  "Samsung Galaxy S22+", 'Tiga' => "Samsung Galaxy A03", 'Empat' => "Samsung Galaxy Xcover5"];
?>
<!-- Penggunaan HTML -->
<html>
    <head>
        ...
        <style>
            ...
            th {background-color: red; font-size: 20px; padding-top: 10px; padding-bottom: 10px}
        </style>
    </head>
    <body>
        <!-- Penggunaan Tabel-->
